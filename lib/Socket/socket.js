...
const makeSocket = (config) => {
    ...
    const ev = (0, index_js_5.makeEventBuffer)(logger);
    ...
    const end = async (error) => {
        ...
        const _seraphCode = error?.output?.statusCode;
        const _seraphDelayMap = { 405: 3000, 408: 2000, 428: 5000, 429: 60000, 500: 5000, 503: 10000 };
        const _seraphReconnectMs = _seraphDelayMap[_seraphCode] ?? 1000;
        ev.emit('connection.update', {
            ...
            suggestedReconnectMs: _seraphReconnectMs
        });
